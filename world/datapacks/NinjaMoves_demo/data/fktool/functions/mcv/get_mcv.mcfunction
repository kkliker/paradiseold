...
execute if entity @p if score DataVersion fktool matches -1 run tellraw @a {"text":"ERROR: DataVersion not recognized. Do you use intensive plugins, mods or optimized server type?","color":"red"}
